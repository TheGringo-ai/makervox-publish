...
* **Nothing is created as a side effect of reading.** Importing postvox, loading
...
from postvox.state.paths import ensure_dir as _ensure_dir
...
def ensure_dir(path: str, mode: int = 0o700) -> None:
    ...
    Thin alias for :func:`postvox.state.paths.ensure_dir` so there is one
