"""Every exception postvox raises on purpose.

Layering rule: this module imports nothing from postvox, so any module may
...
class TokenRotationError(PostvoxError):
    ...
    def __init__(self, platform: str, account: str, detail: str = "") -> None:
        super().__init__(
            ...
            "`postvox auth {0} {1}` to re-authorize.".format(
