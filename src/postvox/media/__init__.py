"""postvox.media — external binaries and the media helpers every platform shares.
...
from postvox.media.cover import (
    BrightnessSample,
...
from postvox.media.ffmpeg import FfmpegTools, find_binary
from postvox.media.probe import MediaInfo, duration_s, probe
