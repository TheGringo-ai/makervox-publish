...
raises :class:`~postvox.errors.ReauthorizationRequired` with an explicit
...
from postvox.errors import IdentityClash, PostvoxError, ReauthorizationRequired
from postvox.logging import get_logger, mask
from postvox.platforms.tiktok.errors import TikTokApiError, is_scope_error
...
def credential_spec(cfg) -> CredentialSpec:
    ...
    return CredentialSpec(
        ...
        setup=SETUP_HINT.format(prog="postvox"),
...
class TikTokAuth:
    ...
    def __init__(
        ...
        *,
        ...
        self.http = http
        self.program_name = program_name or "postvox"
