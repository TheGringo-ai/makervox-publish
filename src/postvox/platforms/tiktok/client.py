...
from postvox.http import HttpClient, TransportError
from postvox.logging import get_logger
from postvox.media.ffmpeg import FfmpegTools
from postvox.media.transcode import TranscodeSettings, sized_for_upload
from postvox.platforms import PublishResult
from postvox.platforms.tiktok.auth import SETUP_HINT, TikTokAuth, credential_spec
from postvox.platforms.tiktok.errors import TikTokApiError, raise_for_api_error
from postvox.platforms.tiktok.insights import TikTokInsights
from postvox.platforms.tiktok.upload import plan_chunks, upload_chunks
...
class TikTokClient:
    ...
    def from_config(
        ...
        *,
        ...
        """Build from a whole :class:`postvox.Config`."""
...
def publisher(config, **kwargs) -> TikTokClient:
    """Factory discovered by :func:`postvox.platforms.publisher_for`."""
