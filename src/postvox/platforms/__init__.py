"""postvox.platforms — the publishers, and the one result shape they share.
...
``postvox/__init__.py``, so a caller who only wants the config loader does not
...
cover picker went down to :mod:`postvox.media.cover`, and the Page lookup became
a resolver both publishers depend on and neither owns. Facebook and Instagram
then ship in ONE subpackage (:mod:`postvox.platforms.meta`) because they share
...
PLATFORMS = {
    "facebook": "postvox.platforms.meta.facebook",
    "instagram": "postvox.platforms.meta.instagram",
    "tiktok": "postvox.platforms.tiktok.client",
    "x": "postvox.platforms.x.client",
}
