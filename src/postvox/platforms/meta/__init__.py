...
* the cover picker moved DOWN to :mod:`postvox.media.cover`, which both import;
* Page credentials became :class:`~postvox.platforms.meta.tokens.PageResolver`,
  a Protocol living in :mod:`postvox.platforms.meta.tokens` that both depend on
  and neither owns.
