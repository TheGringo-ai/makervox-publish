...
from postvox.errors import ConfigError, StagingPreconditionError
from postvox.logging import get_logger
from postvox.platforms.meta.staging import StagedMedia, content_type_for
...
class GcsStager:
    ...
    def _storage(self):
        ...
        Importing postvox must not import a cloud SDK: the extra is optional and
