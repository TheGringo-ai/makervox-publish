...
from postvox.errors import PostvoxError
...
class HttpPolicy:
    ...
    def from_config(cls, http_cfg) -> "HttpPolicy":
        """Build from a :class:`postvox.config.HttpConfig`."""
        ...
        return cls(
            user_agent=getattr(http_cfg, "user_agent", "postvox"),
