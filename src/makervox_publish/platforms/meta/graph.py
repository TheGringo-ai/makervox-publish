...
:mod:`makervox_publish.platforms.meta.compat`.
"""
...
class GraphEndpoints:
    ...
    def from_config(cls, platform_cfg) -> "GraphEndpoints":
        """Build from :class:`makervox_publish.config.FacebookConfig` (or Instagram's)."""
        return cls(
...
class GraphSession:
    """Thin, token-per-call wrapper over :class:`makervox_publish.http.HttpClient`.
